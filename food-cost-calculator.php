...
<head>
    ...
    <meta name="description" content="Cost recipes, see food cost %, and get a suggested menu price. Free playground (resets nightly) or start a no-card 14-day trial.">
    ...
    <meta property="og:description" content="Cost recipes, see food cost %, and get a suggested menu price. Free playground (resets nightly) or start a no-card 14-day trial.">
    ...
    <meta name="twitter:description" content="Cost recipes, see food cost %, and get a suggested menu price. Free playground or no-card 14-day trial.">
    ...
    <script type="application/ld+json">
    {
      ...
      "description": "Cost recipes, see food cost %, and get a suggested menu price. Free playground or no-card 14-day trial.",
      "offers": {
        "@type": "Offer",
        "price": "0",
        "priceCurrency": "USD",
        "description": "Free playground and 14-day free trial (no card)"
      },
      "provider": {
        "@type": "Organization",
        "name": "ilovepbj ops",
...
<body>
    <nav class="nav">
        ...
        <div class="nav-actions">
            ...
            <a class="btn btn-mint btn-sm" href="/register?mode=playground">Free playground</a>
        </div>
    </nav>
    ...
    <header class="hero">
        ...
        <div class="hero-ctas">
            <a class="btn btn-primary" href="/register?mode=playground">Try the free playground</a>
        ...
        <p class="hero-sub">Playground resets nightly · trial keeps your recipes &amp; costs</p>
    </header>
    ...
    <section class="section" id="try-free">
        ...
        <p class="lead">Pick playground for a nightly-reset sandbox, or a real trial that keeps your data.</p>
        <div class="try-grid">
    ...
    <section class="section" id="why">
        ...
        <div class="cta-band">
            ...
            <p>Start in the free playground, or open a real house with a no-card trial.</p>
    ...
    <footer class="footer">
        ...
        <p><a href="/">Home</a> · <a href="/register?mode=playground">Playground</a> · <a href="/register">Free trial</a> · <a href="/login">Log in</a></p>
        <p>
